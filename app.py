...
def predict():
    ...
    try:
        ...
        return render_template('results.html',quote=quote,rnn_pred=round(rnn_pred,2),gru_pred=round(gru_pred,2),
                               ...
                               error_rnn=round(error_rnn,2),error_gru=round(error_gru,2),error_lstm=round(error_lstm,2),error_bilstm=round(error_bilstm,2))
